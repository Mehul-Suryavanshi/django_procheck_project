...
def domain_statistics(req) :
        ...
        domains = ['BlockChain','Data Analysis','Web Development','Computer Networks and Communication','Machine Learning','Cyber Security and Ethical Hacking','Other']
        ...
        for i in rows:
            ...
            if i.domain == "Web Development":
                x[2]+=1
            if i.domain == "Computer Networks and Communication":
                x[3]+=1
            if i.domain == "Machine Learning":
                x[4]+=1
            if i.domain == "Cyber Security and Ethical Hacking":
                x[5]+=1
            if i.domain == "Other":
                x[6]+=1                        
        ...
        plt.xticks(index, domains, fontsize=10, rotation=30)
...
def thrust_statistics(req) :
        ...
        areas = ['Industry','Quality Education','Agriculture','Transportation','Machine Learning','Other']
        ...
        for i in rows:
            ...
            if i.thrust_area == "Transportation":
                x[3]+=1
            if i.thrust_area == "Sanitation and Hygiene":
                x[4]+=1
        ...
        plt.ylabel('Number of groups', fontsize=5)
        plt.xticks(index, areas, fontsize=10, rotation=30)
